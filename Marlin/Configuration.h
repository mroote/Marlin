...
#define STRING_CONFIG_H_AUTHOR "(Mitch, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 492.06
  #define DEFAULT_bedKi 92.41
  #define DEFAULT_bedKd 655.05
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 750   // (ms) Enable and increase if needed
#endif
